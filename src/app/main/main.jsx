...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    // callback to THIS component. ctx.revert() on unmount will kill/undo
    // only these animations (including unwinding any ScrollTrigger pin
    // spacers), without ever touching animations belonging to any other
    // mounted component (e.g. the page-transition grid in TransitionProvider).
    ...
    return () => {
      ...
      mouseCleanup();
      // Reverts every tween/timeline/ScrollTrigger created inside the
      // gsap.context() callback above, and unwinds any ScrollTrigger
      // pin-spacers, restoring the DOM before React unmounts this tree.
      // Scoped to this component only — never touches TransitionProvider's
      // in-flight page-transition animation.
      ctx.revert();
      document.body.style.overflow = "";
    };
  }, []);
    ...
    <div className={styles.wrapper} ref={wrapperRef}>
      ...
      <div className={styles.footer}>
        {/* <div className={styles.footerImg}>
          <img src="/footer.jpg" alt="" className={styles.image} />
        </div>*/}
      </div>
    </div>
  );
